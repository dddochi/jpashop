...
public class OrderServiceTest {
    ...
    public void 주문상품_재고수량초과() throws Exception{//예외 TEST -> 정말 중요
            //재고 수량이 초과되면 이 Exception이 터져야함
        //given
        Member member = createMember();
        Book book = createBook("시골 JPA", 10000, 10);
    ...
    public void 주문_취소() throws Exception{
        ...
        int orderCount = 2;
        Long orderId = orderService.order(member.getId(), book.getId(), orderCount); //데이터 세팅, 주문까지 준비가 됨
